/*
 ...
 1. При першому виклику `curriedAdd` приймає перший
  аргумент `a` і повертає функцію, яка приймає другий аргумент.
 2. При другому виклику ця повернена функція приймає
  другий аргумент `b` і повертає ще одну функцію,
   яка приймає третій аргумент.
 3. При третьому виклику остання функція 
 приймає третій аргумент `c` і повертає суму `a + b + c`.
...
/*
 ...
 При першому виклику curriedAdd приймає перший
  аргумент a і повертає функцію, яка приймає другий аргумент.
 При другому виклику ця повернена функція приймає
  другий аргумент b і повертає ще одну функцію,
   яка приймає третій аргумент.
 При третьому виклику остання функція приймає 
 третій аргумент c і повертає суму a + b + c.
*/
